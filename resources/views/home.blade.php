...
<div class="container-fluid p-5 bg-secondary fondo">
    ...
    <button class="boton" id="reviewButton">Añadir reseña</button>
</div>
<script>
                ...
                <div class="row g-0">
                  ...
                  <div class="col-md-8">
                    <div class="card-body" >
                      ...
                      <p class="card-text" style="height: 72px">Fonda del Mercado de la Sierra. Horario de 8:00 a 19:00, Lunes a Viernes.</p>
                      <div>
                ...
                <div class="row g-0">
                  ...
                  <div class="col-md-8">
                    <div class="card-body">
                      ...
                      <p class="card-text" style="height: 72px">Restaurante Caro. Horario de 8:00 a 19:00, Lunes a Viernes.</p>
                      <div>
                        <span class="fa fa-star checked"></span>
                        <span class="fa fa-star checked"></span>
                        <span class="fa fa-star checked"></span>
                ...
                <div class="row g-0">
                  ...
                  <div class="col-md-8">
                    <div class="card-body">
                      ...
                      <p class="card-text" style="height: 72px">Pizzería famosa de la ciudad. Horario de 8:00 a 19:00, Lunes a Viernes.</p>
                      <div>
                        <span class="fa fa-star checked"></span>
                        <span class="fa fa-star checked"></span>
                        <span class="fa fa-star"></span>
            ...
            <div class="row g-0" style="min-height: 300px"> 
              {{-- <div class="card mb-3"> --}}
                ...
                <br>
                  ...
                  <p class="card-text review" style="height: 72px;">Ordené una hamburguesa y me trajeron una Pizza. Pesimo Servicio, no volveré a comer aquí no lo recomiendo. Además, la hamburguesa no estaba tan buena.</p>
                  <br>
                  <div>
            ...
            <div class="row g-0" style="min-height: 300px">
              {{-- <div class="col-md-8"> --}}
                ...
                <br>
                  ...
                  <p class="card-text review" style="height: 72px;">La experiencia en ese restaurante fue decepcionante; la comida estaba insípida y el servicio era lento e ineficiente. No lo recomendaría.</p>
                  <br>
                  <div>
                    <span class="fa fa-star fa-lg"></span>
                    <span class="fa fa-star  fa-lg"></span>
